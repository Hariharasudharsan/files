...
export type OutboxEventWhereInput = {
  ...
  published?: Prisma.BoolFilter<"OutboxEvent"> | boolean
...
export type OutboxEventScalarWhereWithAggregatesInput = {
  ...
  published?: Prisma.BoolWithAggregatesFilter<"OutboxEvent"> | boolean
...
export type OutboxEventOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "aggregateId" | "aggregateType" | "eventType" | "payload" | "published" | "createdAt", ExtArgs["result"]["outboxEvent"]>
...
export interface OutboxEventFieldRefs {
  ...
  readonly published: Prisma.FieldRef<"OutboxEvent", 'Boolean'>

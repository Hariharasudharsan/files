...
export default function AdminSettingsPage() {
  return (
    <div className="space-y-8 max-w-4xl">
      ...
      <div className="bg-white rounded-2xl border border-surface-200 shadow-sm p-6 space-y-8">
        <div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  type="email"
                  defaultValue="support@mathuram.com"
                  className="w-full rounded-xl border border-surface-300 bg-white px-4 py-2 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
                />
              </div>
            </div>
        ...
        <div className="pt-6 border-t border-surface-100">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <input
                type="text"
                defaultValue="Mathuram Foods - Authentic Organic Spices"
                className="w-full rounded-xl border border-surface-300 bg-white px-4 py-2 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
              />
            </div>
            <div className="space-y-2">
              ...
              <textarea
                rows={3}
                defaultValue="Discover our premium range of organic spices and authentic food products..."
                className="w-full rounded-xl border border-surface-300 bg-white px-4 py-2 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
              />
            </div>
          </div>

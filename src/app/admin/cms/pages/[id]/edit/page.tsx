      ...
      <form action={submitAndRedirect} className="space-y-6 bg-white p-8 rounded-2xl border border-surface-200 shadow-sm">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="col-span-2 sm:col-span-1">
            ...
            <input required type="text" name="title" defaultValue={page.title} className="w-full border-surface-300 rounded-lg px-4 py-2" />
          </div>
          <div className="col-span-2 sm:col-span-1">
            ...
            <div className="flex items-center">
              ...
              <input required type="text" name="slug" defaultValue={page.slug} className="w-full border-surface-300 rounded-r-lg px-4 py-2" />
            </div>
          </div>
        </div>
